...
public:
	...
	static float signed_tetrahedron_volume(FPoint3 a, FPoint3 b, FPoint3 c, FPoint3 d);
	static bool triangle_line_collision(const Triangle &triangle, const Line &segment);

	static bool tri_tri_overlap_test_3d(const Triangle &tri1, const Triangle &tri2);
